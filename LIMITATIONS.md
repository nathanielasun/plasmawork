...
**Last updated: 2026-05-06 (Phase 0.5 Layer-1 primitives are implemented and the five Layer-0 ADRs are accepted. The secure multi-user HTTP server, middleware stack, sandbox runtime service, and cut-over from the single-user FastAPI workbench are still future work.)**
