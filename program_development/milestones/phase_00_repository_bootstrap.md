...
| 0D | Development History System | Done | timeline + 3 ADRs + 11 plan-matching milestone stubs |
...
- [x] `program_development/` populated with timeline, ADR-0001..0003, Phase 0-10 milestone stubs
- [x] Repository convention checker script (`scripts/dev/check_repo_conventions.sh`, 116 checks)
...
7. ☑ Convention checker runs and passes (116/116 checks ok on 2026-05-02).
...
- Follow-up correction on 2026-05-02 expanded the checker to cover plan-required package manifests, executable documented scripts, and all Phase 0-10 milestone filenames. See `bugs_and_fixes/bugfixes.md`.
